...
$PAGE->set_title(get_string('edit') . get_string('pluginname', 'local_greetings'));
...
$canedit = has_capability('local/greetings:editanymessage', $context) ||
    (has_capability('local/greetings:editownmessage', $context) && $result->userid == $USER->id);
